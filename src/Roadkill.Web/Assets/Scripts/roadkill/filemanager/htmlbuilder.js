        ...
        (function (FileManager) {
            var HtmlBuilder = (function () {
                ...
                HtmlBuilder.prototype.getFolderTable = function (directoryViewModel) {
                    ...
                    var header = "<table id=\"files\"><thead><tr>" + "<th colspan=2>" + ROADKILL_FILEMANAGER_COLUMN_NAME + "</th>" + "<th>" + ROADKILL_FILEMANAGER_COLUMN_DATE + "</th>" + "<th>" + ROADKILL_FILEMANAGER_COLUMN_TYPE + "</th>" + "<th>" + ROADKILL_FILEMANAGER_COLUMN_SIZE + "</th>" + "</tr></thead>";
                    html.push(header);
